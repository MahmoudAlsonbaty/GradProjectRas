...
//     try {
//       _serial = Serial(_selectedPort, Baudrate.b9600);
//       setState(() {
...
//     setState(() {
//       _status = 'Scanning (reading from serial)...';
//     });
//     try {
//       final response = _serial?.read(128, 2000);
//       String output = response?.toString() ?? 'No data received from serial.';
//       if (output.isEmpty) output = 'No data received from serial.';
//       if (!mounted) return;
//       showDialog(
//         context: context,
